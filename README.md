...
Hello Rails Backend Project Is an api that generates random greetings.

## Frontend

The api is consumed by this [React project](https://github.com/peter-akhigbe/hello-react-front-end)
...
Feel free to check the [issues page](https://github.com/peter-akhigbe/hello-rails-back-end/issues).
